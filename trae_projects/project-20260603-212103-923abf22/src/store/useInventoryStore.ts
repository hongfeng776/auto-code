...
import type { Warehouse, SkuItem, Supplier, ReplenishmentSuggestion, AlertRecord, SimulationParams, TrendDataPoint } from '@/types'
import { warehouses as initWarehouses, skuItems as initSkuItems, suppliers as initSuppliers, replenishmentSuggestions as initSuggestions, alertRecords as initAlerts, trendData as initTrendData } from '@/data/mockData'
